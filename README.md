...
Le BigBang vient d'avoir lieu (ie: vous venez d'ouvrir votre IDE et de cliquer sur `new project`)

Vous tenez le rôle de `Maker` : vous allez devoir créer différentes class pour représenter notre nouvel univers.
